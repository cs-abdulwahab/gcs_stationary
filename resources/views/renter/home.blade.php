    ...
    <div id="navigation" style="margin-top: 100px;">
		...
		<div class="container">
			<div id="responsive-nav">
				...
				<a href="{{route('renter.index')}}">	<span class="category-header">Rent kro </i></span> </a>
              ...
              @foreach($orders as $key=> $order)
				<div class="chat_list active_chat">
				  <div class="chat_people">
					...
					<div class="chat_ib">
                    <li><span class="label label-info">{{$order->name}}</span> <a href="javascript:void(0);" class="chat-toggle" data-id="{{$order->id}}" data-user="{{$order->name}}">Open chat</a></li>
