	...
	<div class="section bg-img">
	   ...
	   @endif
		...
		<div class="container">
			<!-- row -->
			<div class="row">
				<form  method="POST" action="{{ isset($user) ? route('renter.update',$user->id) : route('user.store')}}"  id="checkout-form" class="clearfix">
                  @csrf
                  @if(isset($user))
                  @method('PUT')
                  @endif
						...
						<div class="billing-details">
                            ...
                            <div class="form-group">
								<input class="input" value="{{ isset($user->phone ) 
                                   ? $user->phone:''}}" type="phone" name="phone" placeholder="Phone" >
							</div>
							<div class="form-group">
